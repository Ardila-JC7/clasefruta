...
dulzor = st.number_input("Dulzor (0 - 15)", value=8.0)
...
distancia_cereza = math.sqrt(
    (fruta_usuario[0] - cereza[0])**2 +
    (fruta_usuario[1] - cereza[1])**2 +
    (fruta_usuario[2] - cereza[2])**2
)
...
st.write("🍒 Cereza:", distancia_cereza)
